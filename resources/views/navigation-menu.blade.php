<nav x-data="{ open: false }" class="bg-[#041332] text-white border-b border-gray-100 sticky top-0 position: fixed; text-white">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1 bg-gray-500 ">
            @auth
